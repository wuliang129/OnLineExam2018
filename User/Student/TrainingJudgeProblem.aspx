<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/common_head.master" AutoEventWireup="true" CodeFile="TrainingJudgeProblem.aspx.cs" Inherits="Web_student_TrainingJudgeProblem" %>
                      ...
                      <div class="question"  style="border: 1px dashed rgb(255, 255, 255);">
                            ...
                            <table width="100%"  border="0" bgcolor="#F1F1F1">
                                <tbody><tr >
                                    ...
                                    <td width="240px">
                                        <div class="danxuan" style="width: 112px; height: 23px; line-height: 23px; float: left; background-image:url(xuanz_bg.png);">&nbsp;<asp:RadioButton 
                                                ID="radiobtn_AnswerTrue" runat="server" Text="正确（true）" GroupName="S1"/></div>
                                        <div class="danxuan" style="width: 112px; height: 23px; line-height: 23px; float: left; background-image:url(xuanz_bg.png);">&nbsp;<asp:RadioButton 
                                                ID="radiobtn_AnswerFalse" runat="server" Text="错误（false）" GroupName="S1"/></div>
                                    </td>
