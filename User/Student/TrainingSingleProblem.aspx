<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/common_head.master" AutoEventWireup="true" CodeFile="TrainingSingleProblem.aspx.cs" Inherits="Web_student_TrainingSingleProblem" %>
        ...
        <tr>
            <td valign="top" align="left">
                ...
                <table cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse" width="100%" frame="below">
                    <tr>
                        <td style="text-align: right; width: 250px;">选择练习科目：<asp:DropDownList ID="ddliProblems" runat="server" Width="200px"
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="question" style="border: 1px dashed rgb(255, 255, 255);">
                                <p>
                                    <span style="color: #09F; font-weight: bold;">第&nbsp;<asp:Label ID="lbl_ProblemIndex" runat="server"
                                ...
                                <table width="100%" border="0" bgcolor="#F1F1F1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="350px">
                                                <div class="danxuan" style="width: 80px; height: 23px; line-height: 23px; float: left;">
                                                    &nbsp;<asp:RadioButton
                                                        ID="radiobtn_AnswerA" runat="server" Text="" GroupName="S1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A
                                                </div>
                                                <div class="danxuan" style="width: 80px; height: 23px; line-height: 23px; float: left; ">&nbsp;<asp:RadioButton ID="radiobtn_AnswerB" runat="server" Text="" GroupName="S1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B</div>
                                                <div class="danxuan" style="width: 80px; height: 23px; line-height: 23px; float: left; ">&nbsp;<asp:RadioButton ID="radiobtn_AnswerC" runat="server" Text="" GroupName="S1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C</div>
                                                <div class="danxuan" style="width: 80px; height: 23px; line-height: 23px; float: left; ">&nbsp;<asp:RadioButton ID="radiobtn_AnswerD" runat="server" Text="" GroupName="S1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D</div>
                                            </td>
                        ...
                        <td colspan="2">
                            <table style="width: 540px; height: 35px; margin-left: 15px;">
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <span style="color: #09F; font-weight: bold; font-size: 14px;">
                                                <asp:Label ID="lbl_indexVScount" runat="server"
                                                    Text="题目序号"></asp:Label></span>&nbsp;&nbsp;
                                        </p>
                                    </td>
                                        ...
                                        <p>
                                            <span style="color: #09F; font-weight: bold; font-size: 14px;">
                                                <asp:CheckBox ID="chk_DisplayExplain" runat="server" Text="显示答案"
                                                    ...
                                                    OnCheckedChanged="chk_DisplayExplain_CheckedChanged" /></span>&nbsp;&nbsp;
                                        </p>
                                    </td>
                                </tr>
                            </table>
