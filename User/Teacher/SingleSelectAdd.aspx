<%@ Page Language="C#" MasterPageFile="~/MasterPage/common_head.master" AutoEventWireup="true" CodeFile="SingleSelectAdd.aspx.cs" Inherits="Web_SingleSelectAdd" %>
        ...
        <tr style="background: url(~/Images/lineS.jpg) repeat-x;">
          ...
          <tr>
            ...
            <td  valign="top" align="left" width="960px">
               ...
               <tr>
                    <td bgcolor="#eeeeee"  colspan="2"> <div class="title" align="left"><h4>单选题</h4></div></td>                    
                </tr>
                <tr>
