                                        ...
                                        <ul class="toolbar">
                                            <li class="click_nodisplay">
                                                <div class="oneLine_save">
                                                    <asp:LinkButton ID="lbtn_Save" runat="server" OnClick="lbtn_Save_Click" CausesValidation="False" >保存</asp:LinkButton>
                                                </div>
                                            </li>
                                            <li class="click_nodisplay">
                                                <div class="oneLine_back">
                                                    <asp:LinkButton ID="lbtn_Back" runat="server" OnClick="lbtn_Back_Click" CausesValidation="False" >返回</asp:LinkButton>
                                                </div>
                                            </li>
                                        </ul>
                                    </td>
                                    <td ><asp:Label ID="lblMessage" runat="server" Width="350px" ForeColor="Red"></asp:Label></td>
                                </tr>
                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            (本题得分：<asp:TextBox ID="tbxqueScore" runat="server"
                                                                                Text='<%# Eval("CurrentScore","{0}") %>' Width="50px"></asp:TextBox>
