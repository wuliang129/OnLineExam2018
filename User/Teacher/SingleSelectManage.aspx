<%@ Page Language="C#" MasterPageFile="~/MasterPage/common_head.master" AutoEventWireup="true" CodeFile="SingleSelectManage.aspx.cs" Inherits="Web_SingleSelectManage" %>
        ...
        <tr style="background: url(../Images/lineS.jpg) repeat-x;">
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
                                      ...
                                      <h4>&gt;&gt;单选题管理</h4><hr/>
               <p align="left"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="True" Width="130px" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged"></asp:DropDownList></p>
